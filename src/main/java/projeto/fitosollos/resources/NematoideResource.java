...
public class NematoideResource {
	...
	@Autowired
	private NematoideService service;
	
	@GetMapping
	public ResponseEntity<List<Nematoide>> findAll(){
		List<Nematoide> list = service.findAll();
	...
	@PostMapping
	public ResponseEntity<Nematoide> insert(@RequestBody Nematoide obj){
