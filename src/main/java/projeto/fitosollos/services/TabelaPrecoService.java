...
public class TabelaPrecoService {
	...
	public void update(Integer id, TabelaPrecoDTO tabelaPrecoDTO) {
		...
		tabelaPreco.setTabId(id);
		repository.save(tabelaPreco);
	}

	// utilitarios
	public TabelaPreco fromDTO(TabelaPrecoNewDTO tabelaPrecoNewDTO) {
		TipoAnalise tipoAnalise = new TipoAnalise(tabelaPrecoNewDTO.getTabAnalise(), null);
		Laboratorio laboratorio = new Laboratorio(tabelaPrecoNewDTO.getTabLaboratorio(), null, null, null, null, null);
		TabelaPreco tabelaPreco = new TabelaPreco(null, tabelaPrecoNewDTO.getTabValor(), tipoAnalise, laboratorio);
		return tabelaPreco;
	}

	public TabelaPreco fromDTO(TabelaPrecoDTO tabelaPrecoDTO) {
		TipoAnalise tipoAnalise = new TipoAnalise(tabelaPrecoDTO.getTabAnalise(), null);
		Laboratorio laboratorio = new Laboratorio(tabelaPrecoDTO.getTabLaboratorio(), null, null, null, null, null);
		TabelaPreco tabelaPreco = new TabelaPreco(null, tabelaPrecoDTO.getTabValor(), tipoAnalise, laboratorio);
		return tabelaPreco;
	}
